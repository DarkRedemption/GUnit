...
function assertClass:lessThan(otherValue)
  ...
  assert(self.funcOrValue < otherFuncOrValue, 
    tostring(self.funcOrValue) .. " of type " .. type(self.funcOrValue) ..
    " was not less than " .. tostring(otherFuncOrValue) .. " of type " .. type(otherFuncOrValue))
end
...
function assertClass:greaterThan(otherValue)
  ...
  assert(self.funcOrValue > otherFuncOrValue, 
    tostring(self.funcOrValue) .. " of type " .. type(self.funcOrValue) ..
    " was not greater than " .. tostring(otherFuncOrValue) .. " of type " .. type(otherFuncOrValue))
end
